...
This repository contains my implementation of the open source [project](https://github.com/udacity/nd013-c2-fusion-starter) part of the [Udacity - Self-Driving Car NanoDegree](http://www.udacity.com/drive).
...
1. **Object detection**: a deep-learning approach is used to detect vehicles in LiDAR data based on a birds-eye view perspective of the 3D point-cloud. Also, a series of performance measures is used to evaluate the performance of the detection approach.
2. **Object tracking** : an extended Kalman filter is used to track vehicles over time, based on the lidar detections fused with camera detections. Data association and track management are implemented as well.
